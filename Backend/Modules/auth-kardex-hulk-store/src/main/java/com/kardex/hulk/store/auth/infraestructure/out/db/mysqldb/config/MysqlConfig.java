...
@EnableJpaRepositories(
        ...
        basePackages = {"com.kardex.hulk.store.auth.infraestructure.out.db.mysqldb.repository"})
public class MysqlConfig {
    ...
    public LocalContainerEntityManagerFactoryBean mysqlEntityManagerFactory(EntityManagerFactoryBuilder builder,
        ...
        return builder
                ...
                .packages("com.kardex.hulk.store.auth.infraestructure.out.db.mysqldb.entities")
