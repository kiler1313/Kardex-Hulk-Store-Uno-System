...
public class UtilHelper {
     ...
     * @param productsListDto
     * @return
     */
    public static ResponseEntity<Object> utilCreateResponseQueryProducts(List<ProductDto> productsListDto)
    {
        ResponseEntity<Object> response = null;
        if (!Objects.isNull(productsListDto))
        {
            response = new GeneralBasicResponse().buildResponseEntity(StatusMessages.HTTP_SEND_OK.getStatusCode(),
                    ...
                    StatusMessages.HTTP_SEND_OK.getHttpStatusCode().value(), HttpStatus.OK, productsListDto);
        }
        else
        {
