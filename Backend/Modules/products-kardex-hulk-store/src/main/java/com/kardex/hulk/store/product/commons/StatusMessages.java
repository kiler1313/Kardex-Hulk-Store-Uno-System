...
public enum StatusMessages {
    ...
    HTTP_REQUEST_REPEATED(HttpStatus.BAD_REQUEST, 606,"La lista de productos a actualizar viene vacia"),
    ...
    HTTP_BAD_REQUEST_DATA_NO_FOUND(HttpStatus.BAD_REQUEST, 612,"Los siguientes productos, no pudieron ser actualizados. Deben ser creados para poder actualizarlos"),
    ...
    HTTP_FORBBIDEN_RESOURCE(HttpStatus.FORBIDDEN, 614,"Recursos prohibido o sin acceso por autenticación");
